...
const totalByMonth = computed(() => {
    // Use backend-calculated monthly totals instead of client-side currency mixing
...
function markUnpaidPayment(payment: Payment) {
    router.patch(
        markUnpaidRoute.url(payment),
        {},
        {
            preserveScroll: true,
        },
...
<template>
    ...
    <div class="space-y-8">
        ...
        <div v-if="Object.keys(groupedUpcoming).length > 0" class="space-y-6">
