...
class RecurringPaymentService
{
    ...
    public function updateRecurringPayment(RecurringPayment $recurringPayment, array $data): RecurringPayment
    {
        return DB::transaction(function () use ($recurringPayment, $data) {
            ...
            // Update existing unpaid payments if the recurring payment is active
            if ($recurringPayment->is_active) {
    ...
    /**
     * Update future payments when recurring payment details change.
     */
    public function updateFuturePayments(RecurringPayment $recurringPayment): void
    {
